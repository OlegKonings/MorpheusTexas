...
const enum RETURN_CODE{NO_ERRORS, INCORRECT_FORMAT, DUPLICATE_NAME, DUPLICATE_CARDS, ANALYSIS_ERROR, FILE_NOT_FOUND, TOO_MANY_PLAYERS,NOT_ENOUGH_DATA};//Error codes which will determine type of error if any, starts at 0 which means no errors
